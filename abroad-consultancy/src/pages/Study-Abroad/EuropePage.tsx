...
const StudyEuropePage: React.FC = () => {
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section className="relative py-16 bg-gradient-to-r from-blue-900 via-purple-700 to-red-600 text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            ...
            <p className="text-xl opacity-90 max-w-3xl mx-auto mb-10">
              Discover world-class education across 44 countries, experience rich cultural diversity, 
              and enjoy seamless travel in the world's most historic and innovative continent.
            </p>
          ...
          <div className="bg-gradient-to-r from-blue-900 to-purple-900 rounded-3xl p-12 text-white">
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <button className="bg-white text-blue-900 px-8 py-4 rounded-xl font-bold text-lg hover:shadow-2xl transition-all">
      ...
      <section className="bg-gradient-to-r from-blue-900 to-purple-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-6">Need Personalized Guidance for Europe?</h2>
          <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
            Our Europe education experts will help you choose the right country and program
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
